...
Fortunately, the years-second decision tree predicts some three year contracts. It maximizes its prediction at 4 contract years if the first-year-percent-of-cap is greater than 10%.
...
The variable importance graph looks like the multinomial model with a slightly less severe division between the first-year-percent-of-cap variable importance and the rest.
...
```{r remove_unused_models,include=FALSE}

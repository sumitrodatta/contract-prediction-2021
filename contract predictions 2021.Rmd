...
For the 2021-2022 season, the salary cap is \$112,414,000. The minimum contract (from [RealGM](https://basketball.realgm.com/nba/info/salary_cap)) is \$1,489,065. Therefore the minimum first year percent of cap in 2021 is  `r formattable::percent(1489065/112414000,digits=2)`.
...
non_options %>% filter(type=="UFA") %>% select(-type) %>% slice(11:15) %>% 
  kable()
```
Batum rebuilt his value after being waived & stretched by the Hornets, becoming a valuable glue guy for the Clippers.